...
module.exports.onChat = async ({ api, event, message }) => {
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("mikasa")) {
            ...
            const baseReplies =  ["আমাকে না ডেকে  MaHiM বসকে একটা জিএফ খুজে দিতে তো পারো 🥺🥺", "বার বার ডাকলে মাথা গরম হয় কিন্তু 😑😒", "-"বেশি বেবি বেবি করলে এমন লাথি দিমু বংশের বাতি নিভে যাবে-"😾😎", "-তোর তো বিয়ে হয় নাই বেবি পাইলি কই, পরকিয়া করছোছ নাকি শালা-;🥲🥴", "Date expire মালের সাথে কথা বলি না!!!😏😴", "-" এত ডাকিস না তো মাথা গরম আছে জামাই নাই-??🙄🫥", "আগে একটু নেচে দেখা তারপর কথা বলবো..!!!😶🤡", "-*কিরে টাকা লাগলেই বেবির কথা মনে পরে ফকিন্নি শালা-.!!!😒😮‍💨" , "-কাইল্লা গো সাথে কথা বলি না "ওয়াক থু"!!!🤮🤢","-পা ধরিস না টাকা নাই-😴😪","-তাড়াতাড়ি বল NASA এর সাথে মিটিং আছে-/!!!🤡🫤"];
