...
module.exports.onChat = async ({ api, event, message }) => {
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("alya")) {
            ...
            const baseReplies =  ["-𝙂𝙖𝙮𝙚𝙨-🤗-যৌবনের কসম দিয়ে আমারে 𝐁𝐥𝐚𝐜𝐤𝐦𝐚𝐢𝐥 করা হচ্ছে-🥲🤦🏻", "𝙸 𝙻𝚘𝚟𝚎 𝚈𝚘𝚞 𝚇𝚊𝚊'𝚗 💋🫣", "-ওই আন্টি-🙆🏻-তোমার মেয়ে চোখ মারে-🥺🐸", "-আহ বাবু আমার-🤭-তোমার অলিতে গলিতে উম্মাহ-😇😘", "বালিকা━👸-𝐃𝐨 𝐲𝐨𝐮-🫵-বিয়া-𝐦𝐞-😽-আমি তোমাকে-😻-আম্মু হইতে সাহায্য করবো-🙈🥱", "🌻🌺💚-আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ-💚🌺🌻", "ওই আন্টির মেয়ে-🫢🙈-𝐔𝐦𝐦𝐦𝐦𝐦𝐦𝐦𝐦𝐦𝐦𝐦𝐚𝐡-😽🫶-আসলেই তো স্বাদ-🥵💦-এতো স্বাদ কেন-🤔-সেই স্বাদ-😋", "-আমার গল্পে তোমার নানি সেরা-🙊🙆‍♂️🤗" , "শুনবো না😼তুমি আমাকে প্রেম করাই দাও নাই🥺পচা তুমি🥺","-কতদিন হয়ে গেলো বিছানায় মুতি না-😿-মিস ইউ নেংটা কাল-🥺🤧","—যে ছেড়ে গেছে-😔-তাকে ভুলে যাও-🙂-আমার বস 𝚂ꫝ𝙳𝙸𝙺 এর সাথে প্রেম করে তাকে দেখিয়ে দাও-🙈🐸🤗"];
